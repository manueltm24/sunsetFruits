...
<div class="wrapper">
    ...
    <section id="intro" class="intro bg-image js-fullscreen-height dark-bg" data-background-img="img_sunsetFruits/finance_bg01.png">
        ...
        <div class="intro-media-wraper overlay-dark40">
            ...
            <!-- End Caption Section -->
            <!-- youtube Video -->
            <div id="video" class="ytp-player" data-property="{videoURL:'https://youtu.be/1p3u-tTAX0g',containment:'#intro', showControls:true, autoPlay:true, loop:true, mute:false, startAt:6, opacity:1, addRaster:false, quality:'default'}"></div>
            <!-- End youtube Video -->
        </div>
    ...
    <!-- Counter Section -->
    <section id="counter" class="overlay-dark80 yellowSunsetFruits-color ptb-80" style="background-image: url(&quot;img_sunsetFruits/finance_bg03.jpg&quot;); background-position: 0% -159px;" data-stellar-background-ratio="0.5">
        <div class="container text-center">
            <div class="row">
...
<!-- Js -->
<script src="js/js_OnePage/plugins/jquery.fitvids.js" type="text/javascript"></script>
<script src="js/plugins/jquery.appear.js" type="text/javascript"></script>
<script src="js/js_OnePage/plugins/jquery.fs.tipper.min.js" type="text/javascript"></script>
<script src="js/js_OnePage/plugins/jquery.countTo.js" type="text/javascript"></script>
<script src="js/js_OnePage/plugins/owl.carousel.min.js" type="text/javascript"></script>
<!-- SLIDER REVOLUTION SCRIPTS  -->
<script src="rs-plugin/js/jquery.themepunch.tools.min.js" type="text/javascript"></script>
<script src="rs-plugin/js/jquery.themepunch.revolution.min.js" type="text/javascript"></script>
<!-- End SLIDER REVOLUTION SCRIPTS  -->
<script src="js/js_OnePage/plugins/jquery.magnific-popup.min.js" type="text/javascript"></script>
<script src="js/js_OnePage/plugins/jquery.singlePageNav.min.js" type="text/javascript"></script>
<script src="js/js_OnePage/plugins/jquery.validate.min.js" type="text/javascript"></script>
